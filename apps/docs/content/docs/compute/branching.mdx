...
- The **first branch** in a project is your production branch, usually `main`. It's protected and durable: deploys to it ask for confirmation, and automated cleanup never touches it.
