...
Want to run this app in the cloud? Deploy it to [Prisma Compute](/compute), serverless TypeScript app hosting in the Prisma platform. Follow [Deploy your first Compute service](/prisma-compute/deploy).
