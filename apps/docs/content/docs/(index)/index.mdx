...
[**Prisma Compute**](/compute) is serverless TypeScript app hosting in the Prisma platform, currently in early access. Deploy Next.js, Hono, TanStack Start, and Bun apps next to your Prisma Postgres database.
