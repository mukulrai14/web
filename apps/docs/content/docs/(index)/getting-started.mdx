...
- [Deploy your first Compute service](/prisma-compute/deploy) to host a TypeScript app on [Prisma Compute](/compute), currently in early access
- [Connect Prisma Compute to Prisma Postgres](/prisma-compute/connect-to-prisma-postgres) once your service is deployed
